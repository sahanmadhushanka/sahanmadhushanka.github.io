...
* `myportpolio` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `myportpolio` - executable or bundle name on disk.
* `myportpolio` - display name shown in window titles and about app dialogs.
